...
export class RangeSliderComponent {
  ...
  public custMinValue: number = 10;
  public custMaxValue: number = 90;
  public noSwatchMinValue: number = 10;
  public noSwatchMaxValue: number = 90;
  public limitValue: number = 50;
  public limitedMinValue: number = 40;
  public limitedMaxValue: number = 60;
  public pushRangeMinValue: number = 60;
  public pushRangemaxValue: number = 70;
  public stepValue: number = 12;
  public customHtmlMinValue: number = 100;
  public customHtmlMaxValue: number = 400;
  public disabledMinValue: number = 10;
  public disabledMaxValue: number = 90;
  public readOnlyValue: number = 50;

  public disabled: boolean = true;
  public readOnly: boolean = true;

  public dateRange: Date[] = this.createDateRange();
  public valueDateRange: number = this.dateRange[0].getTime();

  public simpleSliderControl: FormControl = new FormControl(100);
