...
export class ImageGalleryComponent implements OnInit {
  ...
  public imagesRect: Image[] = [
    new Image(
      0,
      { // modal
        img: 'assets/images/lightgallry/big/01.jpg',
    ...
    new Image(
      1,
      { // modal
        img: 'assets/images/lightgallry/big/02.jpg',
        extUrl: 'http://www.google.com',
        title: 'Portfolio Title',
        description: '<h4>Portfolio Title</h4><p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy.</p>'
      },
    ...
    new Image(
      2,
      { // modal
        img: 'assets/images/lightgallry/big/03.jpg',
        extUrl: 'http://www.google.com',
        title: 'Portfolio Title',
        description: '<h4>Portfolio Title</h4><p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy.</p>'
      },
    ...
    new Image(
      3,
      { // modal
        img: 'assets/images/lightgallry/big/04.jpg',
        extUrl: 'http://www.google.com',
        title: 'Portfolio Title',
        description: '<h4>Portfolio Title</h4><p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy.</p>'
      },
    ...
    new Image(
      7,
      { // modal
        img: 'assets/images/lightgallry/big/08.jpg',
        extUrl: 'http://www.google.com',
        title: 'Portfolio Title',
        description: '<h4>Portfolio Title</h4><p>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy.</p>'
      },
