export class supportDB {
    static ticket = [
...

        {
            ...
            position: "System Architect",
            salary: "<div class='digits'> $320,800</div>",
            office: "Edinburgh",
        ...
        {
            img: "<div class='media'><img class='rounded-circle img-30 mr-3' src='assets/images/user/3.png'><div class='media-body align-self-center'> <div>Garrett Winters</div></div></div>",
            position: "Accountant",
            salary: "$170,750",
            office: "Tokyo",
        ...
        {
            img: "<div class='media'><img class='rounded-circle img-30 mr-3' src='assets/images/user/3.png'><div class='media-body align-self-center'> <div>Jena Gaines</div></div></div>",
        ...
        {
            img: "<div class='media'><img class='rounded-circle img-30 mr-3' src='assets/images/user/3.png'><div class='media-body align-self-center'> <div>C</div></div></div>",
